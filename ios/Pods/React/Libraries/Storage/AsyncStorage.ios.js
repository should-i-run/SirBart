...
var AsyncStorage = {
   ...
   */
  getItem: function(key: string, callback?: ?(error: ?Error, result: ?string) => void): Promise {
   ...
   */
  setItem: function(key: string, value: string, callback?: ?(error: ?Error) => void): Promise {
    return new Promise((resolve, reject) => {
   ...
   */
  removeItem: function(key: string, callback?: ?(error: ?Error) => void): Promise {
    return new Promise((resolve, reject) => {
   ...
   */
  mergeItem: function(key: string, value: string, callback?: ?(error: ?Error) => void): Promise {
    return new Promise((resolve, reject) => {
   ...
   */
  multiRemove: function(keys: Array<string>, callback?: ?(errors: ?Array<Error>) => void): Promise {
    return new Promise((resolve, reject) => {
