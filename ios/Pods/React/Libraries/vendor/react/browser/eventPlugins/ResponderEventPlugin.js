...
function setResponderAndExtractTransfer(
  ...
  if (responderID) {
    ...
    var shouldSwitch =
      !hasDispatches(terminationRequestEvent) || executeDirectDispatch(terminationRequestEvent);
...
function canTriggerTransfer(topLevelType, topLevelTargetID, nativeEvent) {
  return (
    ...
    ((topLevelType === EventConstants.topLevelTypes.topScroll &&
      ...
      (trackedTouchCount > 0 && topLevelType === EventConstants.topLevelTypes.topSelectionChange) ||
...
var ResponderEventPlugin = {
  ...
  extractEvents: function(
    ...
    var isResponderTerminate =
      responderID && topLevelType === EventConstants.topLevelTypes.topTouchCancel;
