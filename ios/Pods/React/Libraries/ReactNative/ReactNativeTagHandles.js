...
var ReactNativeTagHandles = {
   ...
   */
  associateRootNodeIDWithMountedNodeHandle: function(rootNodeID: ?string, tag: ?number) {
   ...
   * `rootNodeID`.
   */
  mostRecentMountedNodeHandleForRootNodeID: function(rootNodeID: string): number {
