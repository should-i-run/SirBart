...
var MatrixMath = {
  ...
  decomposeMatrix(transformMatrix: Array<number>): ?Object {
    ...
    if (matrix[0][3] !== 0 || matrix[1][3] !== 0 || matrix[2][3] !== 0) {
      ...
      var inversePerspectiveMatrix = MatrixMath.inverse3x3(perspectiveMatrix);
      var transposedInversePerspectiveMatrix = MatrixMath.transpose4x4(inversePerspectiveMatrix);
    ...
    if (
      ...
      rotationDegrees = [
        0,
        0,
        MatrixMath.roundTo3Places((Math.atan2(row[0][1], row[0][0]) * 180) / Math.PI),
      ];
    } else {
