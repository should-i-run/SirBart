...
class XMLHttpRequest extends XMLHttpRequestBase {
  ...
  _didCreateRequest(requestId: number): void {
    ...
    this._subscriptions.push(
      RCTDeviceEventEmitter.addListener('didReceiveNetworkResponse', args =>
    ...
    this._subscriptions.push(
      RCTDeviceEventEmitter.addListener('didCompleteNetworkResponse', args =>
        this._didCompleteResponse.call(this, args[0], args[1]),
      ),
    );
  }
