...
var NetInfo = {
  addEventListener: function(eventName: ChangeEventName, handler: Function): void {
    var listener = RCTDeviceEventEmitter.addListener(DEVICE_REACHABILITY_EVENT, appStateData => {
...
if (Platform.OS === 'ios') {
  var _isConnected = function(reachability: ReachabilityStateIOS): boolean {
    return reachability !== 'none' && reachability !== 'unknown';
  };
} else if (Platform.OS === 'android') {
  var _isConnected = function(connectionType: ConnectivityStateAndroid): boolean {
