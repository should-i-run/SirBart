...
if (__DEV__) {
  console.warn = function() {
    ...
    if (!console.yellowBoxResetIgnored && ignoredWarnings.indexOf(warning) !== -1) {
      return;
    }
...
var WarningRow = React.createClass({
  ...
  render: function() {
    ...
    if (warningCounts.get(this.props.warning) > 1) {
      countText = <Text style={styles.bold}>({warningCounts.get(this.props.warning)}) </Text>;
    }
    return (
      <View
...
var WarningBoxOpened = React.createClass({
  render: function() {
    ...
    return (
      <TouchableOpacity activeOpacity={0.9} onPress={this.props.onClose} style={styles.yellowBox}>
        <Text style={styles.yellowBoxText}>
          {countText}
          {this.props.warning}
        </Text>
        <View style={styles.yellowBoxButtons}>
          <TouchableOpacity onPress={this.props.onDismissed} style={styles.yellowBoxButton}>
            <Text style={styles.yellowBoxButtonText}>Dismiss</Text>
          </TouchableOpacity>
          <TouchableOpacity onPress={this.props.onIgnored} style={styles.yellowBoxButton}>
