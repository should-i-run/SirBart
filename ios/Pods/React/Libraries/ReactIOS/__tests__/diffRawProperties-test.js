...
describe('diffRawProperties', function() {
  it('should work with simple example', () => {
    expect(diffRawProperties(null, { a: 1, c: 3 }, { b: 2, c: 3 }, { a: true, b: true })).toEqual({
      a: null,
      b: 2,
    });
  });
  ...
  it('should remove fields', () => {
    expect(diffRawProperties(null, { a: 1 }, {}, { a: true })).toEqual({ a: null });
  });
  ...
  it('should override the updatePayload argument', () => {
    ...
    var result = diffRawProperties(updatePayload, {}, { b: 2 }, { b: true });
  ...
  it('should not use the diff attribute on addition/removal', () => {
    ...
    expect(
      diffRawProperties(null, { a: [1] }, { b: [2] }, { a: { diff: diffA }, b: { diff: diffB } }),
    ).toEqual({ a: null, b: [2] });
  ...
  it('should work with undefined styles', () => {
    expect(diffRawProperties(null, { a: 1, c: 3 }, undefined, { a: true, b: true })).toEqual({
      a: null,
    });
    expect(diffRawProperties(null, undefined, { a: 1, c: 3 }, { a: true, b: true })).toEqual({
      a: 1,
    });
    expect(diffRawProperties(null, undefined, undefined, { a: true, b: true })).toEqual(null);
  });

  it('should work with empty styles', () => {
    expect(diffRawProperties(null, { a: 1, c: 3 }, {}, { a: true, b: true })).toEqual({ a: null });
    expect(diffRawProperties(null, {}, { a: 1, c: 3 }, { a: true, b: true })).toEqual({ a: 1 });
    expect(diffRawProperties(null, {}, {}, { a: true, b: true })).toEqual(null);
  });
