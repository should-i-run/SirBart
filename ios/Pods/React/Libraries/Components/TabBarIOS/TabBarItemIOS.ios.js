...
var TabBarItemIOS = React.createClass({
  ...
  render: function() {
    ...
    if (this.state.hasBeenSelected) {
      tabContents = (
        <StaticContainer shouldUpdate={this.props.selected}>{this.props.children}</StaticContainer>
      );
    } else {
      tabContents = <View />;
    }

    var badge = typeof this.props.badge === 'number' ? '' + this.props.badge : this.props.badge;
