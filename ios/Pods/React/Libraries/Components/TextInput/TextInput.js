...
var TextInput = React.createClass({
  ...
  _renderAndroid: function() {
    ...
    var textAlign = RCTUIManager.AndroidTextInput.Constants.TextAlign[this.props.textAlign];
    ...
    return (
      <TouchableWithoutFeedback onPress={this._onPress} testID={this.props.testID}>
        {textContainer}
      </TouchableWithoutFeedback>
    );
  },
