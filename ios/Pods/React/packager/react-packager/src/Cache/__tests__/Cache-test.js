...
describe('JSTransformer Cache', () => {
  ...
  describe('getting/setting', () => {
    ...
    pit('supports storing multiple fields', () => {
      ...
      var index = 0;
      var loaderCb = jest.genMockFn().mockImpl(() => Promise.resolve(index++));

      return cache.get('/rootDir/someFile', 'field1', loaderCb).then(value => {
        expect(value).toBe(0);
        return cache
    ...
    pit('gets the value from the loader callback', () => {
      ...
      var loaderCb = jest.genMockFn().mockImpl(() => Promise.resolve('lol'));
    ...
    pit('caches the value after the first call', () => {
      ...
      return cache.get('/rootDir/someFile', 'field', loaderCb).then(() => {
        ...
        return cache.get('/rootDir/someFile', 'field', shouldNotBeCalled).then(value => {
    ...
    pit('clears old field when getting new field and mtime changed', () => {
      ...
      var loaderCb = jest.genMockFn().mockImpl(() => Promise.resolve('lol' + mtime));
  ...
  describe('loading cache from disk', () => {
    ...
    pit('should load cache from disk', () => {
      ...
      return cache.get('/rootDir/someFile', 'field', loaderCb).then(value => {
    ...
    pit('should not load outdated cache', () => {
      ...
      var loaderCb = jest.genMockFn().mockImpl(() => Promise.resolve('new value'));
  ...
  describe('writing cache to disk', () => {
    it('should write cache to disk', () => {
      ...
      cache.get('/rootDir/bar', 'field', () => Promise.resolve('bar value'));
      cache.get('/rootDir/foo', 'field', () => Promise.resolve('foo value'));
      cache.get('/rootDir/baz', 'field', () => Promise.resolve('baz value'));
