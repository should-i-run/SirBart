...
describe('Transformer', function() {
  ...
  pit('should loadFileAndTransform', function() {
    ...
    return new Transformer(OPTIONS).loadFileAndTransform('file').then(function(data) {
      expect(data).toEqual({
        code: 'transformed',
        map: 'sourceMap',
        sourcePath: 'file',
  ...
  pit('should add file info to parse errors', function() {
    ...
    return new Transformer(OPTIONS).loadFileAndTransform('foo-file.js').catch(function(error) {
