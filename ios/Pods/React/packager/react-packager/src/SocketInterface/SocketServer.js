  ...
  constructor(sockPath, options) {
    ...
    this._ready = new Promise((resolve, reject) => {
      ...
      this._server.on('listening', () => {
        debug(
          'Process %d listening on socket path %s ' + 'for server with options %j',
          process.pid,
          sockPath,
          options,
        );
    ...
    switch (m.type) {
      case 'getDependencies':
        ...
        this._packagerServer
          ...
          .then(({ dependencies }) => this._reply(sock, m.id, 'result', dependencies), handleError);
        break;
      ...
      case 'buildBundle':
        ...
        this._packagerServer
          .buildBundle(m.data)
          .then(result => this._reply(sock, m.id, 'result', result), handleError);
        break;
