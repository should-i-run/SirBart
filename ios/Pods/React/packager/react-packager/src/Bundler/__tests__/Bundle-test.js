...
describe('Bundle', function() {
  ...
  describe('source bundle', function() {
    it('should create a bundle and get the source', function() {
      ...
      expect(bundle.getSource()).toBe(
        ['transformed foo;', 'transformed bar;', '//@ sourceMappingURL=test_url'].join('\n'),
      );
    });
    ...
    it('should be ok to leave out the source map url', function() {
      ...
      p.finalize({});
      expect(p.getSource()).toBe(['transformed foo;', 'transformed bar;'].join('\n'));
    });
  ...
  describe('sourcemap bundle', function() {
    it('should create sourcemap', function() {
      ...
      p.addModule(
        new ModuleTransport({
          code: ['transformed foo', 'transformed foo', 'transformed foo'].join('\n'),
      ...
      p.addModule(
        new ModuleTransport({
          code: ['transformed bar', 'transformed bar', 'transformed bar'].join('\n'),
