...
describe('HasteDependencyResolver', function() {
  ...
  describe('getDependencies', function() {
    pit('should get dependencies with polyfills', function() {
      ...
      return depResolver.getDependencies('/root/index.js', { dev: false }).then(function(result) {
    ...
    pit('should get dependencies with polyfills', function() {
      ...
      return depResolver.getDependencies('/root/index.js', { dev: true }).then(function(result) {
        expect(result.mainModuleId).toEqual('index');
    ...
    pit('should pass in more polyfills', function() {
      ...
      return depResolver.getDependencies('/root/index.js', { dev: false }).then(result => {
        expect(result.mainModuleId).toEqual('index');
  ...
  describe('wrapModule', function() {
    pit('should resolve modules', function() {
      ...
      return depResolver
        .wrapModule(resolutionResponse, createModule('test module', ['x', 'y']), code)
        .then(processedCode => {
