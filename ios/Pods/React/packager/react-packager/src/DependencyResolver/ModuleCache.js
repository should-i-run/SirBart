...
class ModuleCache {
  ...
  getModule(filePath) {
    ...
    if (!this._moduleCache[filePath]) {
      this._moduleCache[filePath] = new Module(filePath, this._fastfs, this, this._cache);
    }
  ...
  getAssetModule(filePath) {
    filePath = path.resolve(filePath);
    if (!this._moduleCache[filePath]) {
      this._moduleCache[filePath] = new AssetModule(filePath, this._fastfs, this, this._cache);
    }
    return this._moduleCache[filePath];
  }
  ...
  getPackage(filePath) {
    ...
    if (!this._packageCache[filePath]) {
      this._packageCache[filePath] = new Package(filePath, this._fastfs, this._cache);
    }
