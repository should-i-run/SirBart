...
(function(global) {
      ...
      try {
        for (i = 0; args.length < length; i++) {
          ...
          if (!module.inlineRequires[dep]) {
            args.push(
              dep === 'module' ? module : dep === 'exports' ? exports : require.call(null, dep),
            );
          }
        }
  ...
  function define(id, dependencies, factory, _special, _context, _refCount, _inlineRequires) {
    ...
    if (__DEV__) {
      if (
        !factory ||
        (typeof factory != 'object' && typeof factory != 'function' && typeof factory != 'string')
      ) {
        throw new ModuleError(
          'Invalid factory "' +
            factory +
  ...
  function _initDependencies(id) {
    ...
    if (dependencyMap[id]) {
      ...
      for (dep in deps) {
        ...
        if (submodule.waiting === 0 && submodule.special & REQUIRE_WHEN_READY) {
