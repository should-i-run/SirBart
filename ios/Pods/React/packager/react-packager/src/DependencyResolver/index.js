...
HasteDependencyResolver.prototype.getDependencies = function(main, options) {
  ...
  return this._depGraph.getDependencies(main, opts.platform).then(resolutionResponse => {
...
HasteDependencyResolver.prototype.wrapModule = function(resolutionResponse, module, code) {
  return Promise.resolve().then(() => {
    ...
    return Promise.all(
      resolutionResponse.getResolvedDependencyPairs(module).map(([depName, depModule]) => {
        if (depModule) {
