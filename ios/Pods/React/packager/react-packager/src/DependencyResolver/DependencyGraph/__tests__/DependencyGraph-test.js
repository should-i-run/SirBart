...
describe('DependencyGraph', function() {
  ...
  describe('get sync dependencies', function() {
    pit('should get dependencies', function() {
      ...
      fs.__setMockFilesystem({
        root: {
          'index.js': ['/**', ' * @providesModule index', ' */', 'require("a")'].join('\n'),
    ...
    pit('should get dependencies with deprecated assets', function() {
      ...
      fs.__setMockFilesystem({
        root: {
          'index.js': ['/**', ' * @providesModule index', ' */', 'require("image!a")'].join('\n'),
          imgs: {
            'a.png': '',
          },
        },
    ...
    pit('should get dependencies with relative assets', function() {
      ...
      fs.__setMockFilesystem({
        root: {
          'index.js': ['/**', ' * @providesModule index', ' */', 'require("./imgs/a.png")'].join(
            '\n',
          ),
          imgs: {
            'a.png': '',
    ...
    pit('should work with packages', function() {
      ...
      fs.__setMockFilesystem({
        root: {
          'index.js': ['/**', ' * @providesModule index', ' */', 'require("aPackage")'].join('\n'),
          aPackage: {
            'package.json': JSON.stringify({
              name: 'aPackage',
              main: 'main.js',
    ...
    pit('can have multiple modules with the same name', function() {
      ...
      fs.__setMockFilesystem({
        root: {
          'index.js': ['/**', ' * @providesModule index', ' */', 'require("b")'].join('\n'),
          'b.js': ['/**', ' * @providesModule b', ' */'].join('\n'),
          'c.js': ['/**', ' * @providesModule c', ' */'].join('\n'),
          somedir: {
            'somefile.js': ['/**', ' * @providesModule index', ' */', 'require("c")'].join('\n'),
          },
        },
      });
    ...
    pit('should be forgiving with missing requires', function() {
      ...
      fs.__setMockFilesystem({
        root: {
          'index.js': ['/**', ' * @providesModule index', ' */', 'require("lolomg")'].join('\n'),
        },
      });
  ...
  describe('node_modules', function() {
    ...
    pit('node_modules should support multi level', function() {
      ...
      fs.__setMockFilesystem({
        root: {
          'index.js': ['/**', ' * @providesModule index', ' */', 'require("bar");'].join('\n'),
          node_modules: {
            foo: {
              'package.json': JSON.stringify({
                name: 'foo',
          ...
          path: {
            to: {
              'bar.js': ['/**', ' * @providesModule bar', ' */', 'require("foo")'].join('\n'),
            },
            node_modules: {},
          },
        },
        ...
        root: {
          ...
          node_modules: {
            'react-tools': {
              ...
              node_modules: {
                bar: {
                  ...
                  'main.js': ['/**', ' * @providesModule dontWork', ' */', 'hi();'].join('\n'),
                },
                submodule: {
                  'package.json': JSON.stringify({
                    name: 'submodule',
            ...
            ember: {
              ...
              'main.js': ['/**', ' * @providesModule wontWork', ' */', 'hi();'].join('\n'),
            },
          },
        },
      });
    ...
    pit('should ignore modules it cant find (assumes own require system)', function() {
      ...
      fs.__setMockFilesystem({
        root: {
          'index.js': ['/**', ' * @providesModule index', ' */', 'require("foo/lol");'].join('\n'),
          node_modules: {
            foo: {
              'package.json': JSON.stringify({
                name: 'foo',
    ...
    pit('should work with node packages with a .js in the name', function() {
      ...
      fs.__setMockFilesystem({
        root: {
          'index.js': ['/**', ' * @providesModule index', ' */', 'require("sha.js")'].join('\n'),
          node_modules: {
            'sha.js': {
              'package.json': JSON.stringify({
                name: 'sha.js',
  ...
  describe('file watch updating', function() {
    ...
    beforeEach(function() {
      var callbacks = [];
      triggerFileChange = (...args) => callbacks.map(callback => callback(...args));
    ...
    pit('updates module dependencies', function() {
      ...
      return getOrderedDependenciesAsJSON(dgraph, '/root/index.js').then(function() {
        filesystem.root['index.js'] = filesystem.root['index.js'].replace('require("foo")', '');
    ...
    pit('updates module dependencies on file add', function() {
      ...
      return getOrderedDependenciesAsJSON(dgraph, '/root/index.js').then(function() {
        filesystem.root['bar.js'] = ['/**', ' * @providesModule bar', ' */', 'require("foo")'].join(
          '\n',
        );
    ...
    pit('updates module dependencies on deprecated asset add', function() {
      ...
      var filesystem = fs.__setMockFilesystem({
        root: {
          'index.js': ['/**', ' * @providesModule index', ' */', 'require("image!foo")'].join('\n'),
        },
      });
    ...
    pit('updates module dependencies on relative asset add', function() {
      ...
      var filesystem = fs.__setMockFilesystem({
        root: {
          'index.js': ['/**', ' * @providesModule index', ' */', 'require("./foo.png")'].join('\n'),
          'package.json': JSON.stringify({
            name: 'aPackage',
          }),
        },
    ...
    pit('should update node package changes', function() {
      ...
      var filesystem = fs.__setMockFilesystem({
        root: {
          'index.js': ['/**', ' * @providesModule index', ' */', 'require("foo");'].join('\n'),
          node_modules: {
            foo: {
              'package.json': JSON.stringify({
                name: 'foo',
  ...
  describe('getAsyncDependencies', () => {
    pit('should get dependencies', function() {
      ...
      fs.__setMockFilesystem({
        root: {
          'index.js': ['/**', ' * @providesModule index', ' */', 'System.import("a")'].join('\n'),
          'a.js': ['/**', ' * @providesModule a', ' */'].join('\n'),
        },
      });
